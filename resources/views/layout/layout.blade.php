...
<body class="border-top">
    <nav class="navbar navbar-expand-lg mt-lg-2 ps-lg-3 pe-lg-3 pt-2 c-navbar-nav" style="z-index:999;">
        <div class="container-fluid d-flex justify-content-between align-items-center" style="z-index: 1000;">
            ...
            <button class="btn d-block d-sm-none me-2" type="button"
                style="background-color: #FF1717; color: white; font-weight: 1000;" onclick="redirectToPayment()">
                SELL CAR
            </button>
            ...
            <div class="collapse navbar-collapse d-lg-flex gap-lg-4 mobile-menu" id="navbarSupportedContent">
                <ul
                    class="navbar-nav mb-2 mb-lg-0 d-lg-flex gap-lg-2 align-items-lg-center justify-content-lg-center w-100">
                    <li class="nav-item c-navbar-item">
                        <a class="nav-link" href="{{ url('/') }}">
                            <i class="fas fa-home d-lg-none me-2"></i>Home
                        </a>
                    </li>
                    <li class="nav-item c-navbar-item d-block d-md-none">
                    ...
                    <li class="nav-item c-navbar-item">
                        ...
                        <div class="mobile-dropdown d-lg-none">
                            <a class="nav-link d-flex align-items-center justify-content-between" href="#"
                                role="button" onclick="window.location.href='{{ route('forum.index') }}'">
    ...
    <style>
        ...
        @media (max-width: 991px) {
            ...
            .navbar-collapse {
                ...
                transform: scaleY(0);
                /* Use scale instead of translate */
                opacity: 0;
                z-index: 999;
