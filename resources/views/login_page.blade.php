...
<body>
    @php
        ...
        $bgImageStyle =
            $loginImage && $loginImage->value
                ? "background-image: url('" . asset('images/page_sections/' . $loginImage->value) . "');"
    ...
    <div class="main-container" style="{{ $bgImageStyle }}">
        ...
        <div class="top-nav">
            ...
            <a href="/signup_page" style="color:white">Don't have an account? <strong class="register-btn"
                    style="margin-left:10px;">Register</strong></a>
        </div>
            ...
            <form action="{{ route('login_data') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input id="email" class="form-control @error('email') is-invalid @enderror" type="email"
                        name="email" value="{{ old('email') }}" required placeholder="conormmc@gmail.com">
                    @error('email')
                ...
                <div class="form-group">
                    ...
                    <div class="password-container">
                        <input id="passBox" class="form-control @error('password') is-invalid @enderror"
                    ...
                    <div class="action-btn-wrapper">
                        <button type="submit" class="action-btn">
                            ...
                            <span
                                ...
                                <i style="background-color:white; color:black; width:26px; height:26px; border-radius:50%; display:flex; align-items:center; justify-content:center;"
