...
<meta name="description"
    content="Pure Car is the smart way to find your next used car anywhere in Northern Ireland. We offer an extensive range of quality second-hand and nearly-new vehicles across NI">

<meta property="og:image"
    content="{{ asset('images/page_sections/' . $sections->where('section', 'hero')[0]->value) }}" />
...
@section('body')
    ...
    <style>
        ...
        button[disabled] {
            ...
            pointer-events: none;
            /* Ensure it can't be interacted with */
            box-shadow: none;
    ...
    <div class="hero-section-desktop">
        <div class="desktop-hero-section">
            <img style="width:100%; height:90%; filter: brightness(50%); object-fit:cover; z-index:1; cursor: pointer; border-bottom-left-radius: 4em; border-bottom-right-radius: 4em;"
        ...
        <div class="desktop-hero-section-text">
            <div class="desktop-hero-section-innerbox">
                ...
                <form method="GET" action="{{ route('search_car') }}" style="pointer-events: auto;" id="desktopform">
                    ...
                    <div class="">
                        <style>
                            /* layout helpers for the inline form */
                            ...
                            /* Enforce 4px border-radius for buttons, dropdowns and inputs
                                                                                                                                                       inside the desktop search form to override global rules. */
                            #desktopform .btn,
                            #desktopform button,
                            #desktopform .dropdown-toggle,
                            #desktopform .pt-1.pb-1.dropdown,
                            #desktopform .search_color,
                            #desktopform .dropdown-menu,
                            #desktopform .dropdown_menu_col .dropdown-toggle,
                            #desktopform input,
                            #desktopform select {
                                border-radius: 10px !important;
                            }

                            /* Make sure dropdown menu inner corners match */
                            #desktopform .dropdown-menu {
                                overflow: hidden;
                                border-radius: 10px !important;
                            }
                                ...
                                <div class="pt-1 pb-1 dropdown rounded-3 search_color">
                                    ...
                                    <ul class="dropdown-menu scrollable-dropdown">
                                        @foreach ($search_field['body_type'] as $body_type)
                                            <li>
                                                <a class="dropdown-item" href="javascript:void(0)"
                                                    onclick="updateDropdownText('{{ $body_type->body_type }}', 'bodyTypeDropdown', 'bodyTypeInput')">{{ $body_type->body_type }}
                                                    ({{ $body_type->count }})
                                                </a>
                                            </li>
                                        @endforeach
                                ...
                                <div class="pt-1 pb-1 dropdown rounded-3 search_color">
                                    ...
                                    <ul class="dropdown-menu scrollable-dropdown">
                                        @foreach ($search_field['fuel_type'] as $fuel_type)
                                            <li>
                                                <a class="dropdown-item" href="javascript:void(0)"
                                                    onclick="updateDropdownText('{{ $fuel_type->fuel_type }}', 'fuelTypeDropdown', 'fuelTypeInput')">{{ $fuel_type->fuel_type }}
                                                    ({{ $fuel_type->count }})
                                                </a>
                                            </li>
                                        @endforeach
                                ...
                                <div class="pt-1 pb-1 dropdown rounded-3 search_color">
                                    ...
                                    <ul class="dropdown-menu scrollable-dropdown">
                                        @foreach ($search_field['gear_box'] as $gear_box)
                                            <li>
                                                <a class="dropdown-item" href="javascript:void(0)"
                                                    onclick="updateDropdownText('{{ $gear_box->gear_box }}', 'gearboxDropdown', 'gearboxInput')">{{ $gear_box->gear_box }}
                                                    ({{ $gear_box->count }})
                                                </a>
                                            </li>
                                        @endforeach
                        ...
                        <div class="search_box_dropdown_menu extended-filter">
                                ...
                                <div class="pt-1 pb-1 dropdown rounded-3 search_color">
                                    ...
                                    <ul class="dropdown-menu scrollable-dropdown">
                                        @foreach ($search_field['engine_size'] as $engine_size)
                                            <li>
                                                <a class="dropdown-item" href="javascript:void(0)"
                                                    onclick="updateDropdownText('{{ $engine_size->engine_size }}', 'engineSizeDropdown', 'engineSizeInput')">{{ $engine_size->engine_size }}
                                                    ({{ $engine_size->count }})
                                                </a>
                                            </li>
                                        @endforeach
                                ...
                                <div class="pt-1 pb-1 dropdown rounded-3 search_color">
                                    ...
                                    <ul class="dropdown-menu scrollable-dropdown">
                                        @foreach ($search_field['doors'] as $doors)
                                            <li>
                                                <a class="dropdown-item" href="javascript:void(0)"
                                                    onclick="updateDropdownText('{{ $doors->doors }}', 'doorsDropdown', 'doorsInput')">{{ $doors->doors }}
                                                    ({{ $doors->count }})
                                                </a>
                                            </li>
                                        @endforeach
                                ...
                                <div class="pt-1 pb-1 dropdown rounded-3 search_color">
                                    ...
                                    <ul class="dropdown-menu scrollable-dropdown">
                                        @foreach ($search_field['colors'] as $colors)
                                            <li>
                                                <a class="dropdown-item" href="javascript:void(0)"
                                                    onclick="updateDropdownText('{{ $colors->colors }}', 'colorsDropdown', 'colorsInput')">{{ $colors->colors }}
                                                    ({{ $colors->count }})
                                                </a>
                                            </li>
                                        @endforeach
                            ...
                            <div class="dropdown_menu_col">
                                ...
                                <div class="pt-1 pb-1 dropdown rounded-3 search_color">
                                    ...
                                    <ul class="dropdown-menu scrollable-dropdown">
                                        @foreach ($search_field['seller_type'] as $seller_type)
                                            <li>
                                                <a class="dropdown-item" href="javascript:void(0)"
                                                    onclick="updateDropdownText('{{ $seller_type->seller_type }}', 'sellerTypeDropdown', 'sellerTypeInput')">{{ $seller_type->seller_type }}
                                                    ({{ $seller_type->count }})
                                                </a>
                                            </li>
                                        @endforeach
                        ...
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-top: 20px;">
                            ...
                            <div style="display: flex; gap: 10px;">
                                <a onclick="clearFilters()" class="text-center"
                                    style="cursor: pointer; border: 1px solid #d9dadd; background: #ffffff; color: #fb3748; padding: 10px 20px; border-radius: 10px; text-decoration: none;">Clear
                                    All</a>
                                <button id="searchButton" class="search-btn"
                                    style="background: #000000; color: #ffffff; border: none; padding: 10px 30px; border-radius: 14px;">Search</button>
                            </div>
                        </div>
                    </div>
                </form>
    ...
    <div class="hero-section-mobile" style="width: 100%; height:85vh; overflow:hidden;">
        ...
        <form method="GET" action="{{ route('search_car') }}">
            @csrf
            <div
                style="background-color: white; margin-right:20px; padding:20px; height:50vh; overflow:hidden; width:100%;">
                <!-- Make & Model Row -->
                <div class="search_box_dropdown_menu">
                    <!-- Make Dropdown -->
                    ...
                    <div class="dropdown_menu_second_col">
                        <div class="pt-1 pb-1 dropdown rounded-3" style="background-color:#F5F6FA;">
                            <button
                                class="btn  dropdown-toggle w-100 d-flex justify-content-between align-items-center text-truncate"
                                type="button" id="modelDropdown" data-bs-toggle="dropdown" disabled>
                                Model
                            </button>
                            <ul class="dropdown-menu scrollable-dropdown " id="modelList">
                ...
                <div style="display: flex; flex-direction: column; align-items: center; gap: 7px;">
                    ...
                    <a onclick="clearFilters()" class="text-center"
                        style="cursor: pointer; color: #007bff; font-weight: bold; text-decoration: none;">Clear All</a>
                </div>
            </div>
        </form>
    </div>
    ...
    <script>
        // Override the initialization to preserve button text
        (function() {
            const originalTexts = {
                makeDropdown: 'Select Make',
                modelDropdown: 'Select Model',
                variantDropdown: 'Select Variant'
            };

            // Function to update search button text
            function updateSearchButtonText(count) {
            ...
            // Override the updateDropdownText function
            window.updateDropdownText = function(value, dropdownId, inputId, displayLabel = null) {
                ...
                // Only update text if we have a real value
                if (value && value !== 'Any') {
                    dropdown.textContent = displayLabel || value;
                    dropdown.style.color = '#000000';
                } else {
                    // Reset to original text and style
                    dropdown.textContent = originalTexts[dropdownId] || dropdown.textContent;
                    dropdown.style.color = '#525866';
                }

                if (dropdownId === 'makeDropdown') {
                    if (!value || value === 'Any') {
                        document.getElementById('modelDropdown').textContent = originalTexts.modelDropdown;
                        document.getElementById('variantDropdown').textContent = originalTexts.variantDropdown;
                    }
            ...
            // Override the clearFilters function
            window.clearFilters = function() {
                ...
                // Reset dropdowns to original text
                            ...
                            <a href="{{ route('advert_detail', ['slug' => $car_data['slug']]) }}"
                                ...
                                <div class="main_car_card">
                                        ...
                                        <div class="car_card_main_img">
                                            <div class="car_card_inner_img">
                                                <div class="car_card_background_img"
                                                    style="background-image: url('{{ asset('' . e($car_data['image'])) }}');">
                                                </div>
                                    ...
                                    <div class="p-3">
                                        ...
                                        <hr class="mb-3" style="color: rgb(0,0,0,0.5);">

                                        <div class="car_detail d-flex justify-content-around text-center">
                                            {{-- Miles --}}
                                            <div class="car_detail_type">
                                                <i class="fas fa-gauge fs-5 mb-1"></i>
                                                <p class="car_detail_type_text mb-0">
                                            ...
                                            {{-- Fuel Type --}}
                                            <div class="car_detail_type">
                                                <i class="fas fa-gas-pump fs-5 mb-1"></i>
                                                <p class="car_detail_type_text mb-0">
                                            ...
                                            {{-- Gear Box --}}
                                            <div class="car_detail_type">
                                                <i class="fas fa-gear fs-5 mb-1"></i>
                                                <p class="car_detail_type_text mb-0">
                                        ...
                                        <hr class="my-2" style="color: rgb(0,0,0,0.5);">

                                        <div class="height"></div>

                                        <div class="car_detail_bottom d-flex justify-content-between align-items-center">
                                            <p class="car_price mb-0">
                                                {{ e(isset($car_data['price']) && $car_data['price'] > 0 ? '£' . number_format($car_data['price'], 0, '.', ',') : 'POA') }}
                                            </p>
                                            <p class="car_location mb-0" style="color: #002F6C;">
            ...
            async function fetchCars() {
                ...
                try {
                    ...
                    if (data.success) {
                        ...
                        carListingContainer.innerHTML =
                            `<p class="text-center text-danger">${data.message}</p>`;
                    }
                } catch (error) {
                    console.error('Error:', error);
                    carListingContainer.innerHTML =
                        '<p class="text-center text-danger">An error occurred while fetching cars.</p>';
                } finally {
                    hideLoading();
                }
            }
            ...
            <div class="row">
                @foreach ($brands as $index => $brand)
                    <div id="Brands-div" class="mb-4 shadow col-6 col-sm-4 col-md-3 col-lg-2 col-xl-2"
                        onclick="window.open('{{ $brand->link ?? '#' }}', '_blank')" style="cursor: pointer;">
                        <img src="{{ asset($brand->image ? 'images/brands/' . $brand->image : 'images/placeholder.png') }}"
                            class="rounded card-img-top" id="Brands-div-img" alt="{{ $brand->name }}">
                    </div>
                @endforeach
            </div>
            ...
            <div class="row brands-container">
                @foreach ($brands->take(4) as $brand)
                    <div id="brand-{{ $brand->id }}" class="col-6 col-md-6 mb-4">
                        <div class="brand-card shadow" onclick="window.open('{{ $brand->link ?? '#' }}', '_blank')"
                            style="cursor: pointer;">
                            <img src="{{ asset($brand->image ? 'images/brands/' . $brand->image : 'images/placeholder.png') }}"
                                class="rounded card-img-top w-100" alt="{{ $brand->name }}"
    ...
    <div class="counter-container" style="margin-top: 30px; margin-bottom: 30px;">
        <div class="counter-grid">
            @for ($i = 7; $i <= 10; $i++)
                @if (isset($sections->where('section', 'counter')[$i]))
                    <div class="counter-item">
                        <h2>{{ $sections->where('section', 'counter')[$i]->value }}</h2>
                        <p>
                            @if ($i == 7)
                                Car for sale
                            @elseif($i == 8)
        ...
        <div class="blog-container-1">
            ...
            <div class="left-column">
                @foreach ($blogs->take(2) as $blog)
                    <div class="blog-card-1"
                        onclick="window.location.href='{{ route('blog.show', ['blog' => $blog->slug]) }}'">
                        ...
                        <div class="blog-content-1">
                            ...
                            <a class="blog-content-link" href="{{ route('blog.show', ['blog' => $blog->slug]) }}">Read
                                More</a>
                        </div>
                    </div>
                @endforeach
            ...
            <div class="right-column">
                @foreach ($blogs->skip(2)->take(3) as $blog)
                    <div class="right-column-blog-card"
                        onclick="window.location.href='{{ route('blog.show', ['blog' => $blog->slug]) }}'">
                        <div class="right-column-blog-card-img"
                            style="background-image: url('{{ asset('images/blogs/' . $blog->featured_image) }}');"></div>
    ...
    <script>
        ...
        // Function to restore default text if no value is selected
        function restoreDefaultText(buttonId) {
            const button = document.getElementById(buttonId);
            if (button && (!button.textContent || button.textContent.trim() === '')) {
                button.textContent = defaultButtonTexts[buttonId];
            }
        }

        document.addEventListener('DOMContentLoaded', function() {
            // Set initial default texts
            Object.keys(defaultButtonTexts).forEach(buttonId => {
                const button = document.getElementById(buttonId);
                if (button) {
                    button.textContent = defaultButtonTexts[buttonId];
                }
        ...
        function updateDropdownText(value, dropdownId, inputId, displayLabel = null) {
            ...
            if (!value || value === 'Any') {
                ...
                dropdown.textContent = defaultButtonTexts[dropdownId] || dropdown.textContent;
            } else {
                dropdown.textContent = displayLabel || value;
            }
            input.value = value;
            ...
            if (currentFilterValue) {
                if (fieldName === 'make' || fieldName === 'model' || fieldName === 'variant') {
                    ...
                    if (!isCurrentValueStillValid && fieldName !== 'make') {
                        console.log(
                            `Clearing ${fieldName} filter: '${currentFilterValue}' is no longer valid based on current filters.`
                        );
                        window.currentFilters[fieldName.toLowerCase()] = '';
                        input.value = '';
                        dropdown.textContent = fieldLabels[fieldName] || fieldName.charAt(0).toUpperCase() + fieldName
                            .slice(1);
                        ...
                        const matchedOption = sortedOptions.find(option => String(option.value) === String(
                            currentFilterValue));
                        if (matchedOption) {
        ...
        function updateAllDropdowns() {
            ...
            // Store the current button texts before updating
            const makeText = document.getElementById('makeDropdown').textContent;
            const modelText = document.getElementById('modelDropdown').textContent;
            const variantText = document.getElementById('variantDropdown').textContent;
            ...
            for (const [key, value] of Object.entries(window.currentFilters)) {
                ...
                // Restore the original text if no value is selected
                if (!window.currentFilters.make) {
                    document.getElementById('makeDropdown').textContent = makeText;
                }
                if (!window.currentFilters.model) {
                    document.getElementById('modelDropdown').textContent = modelText;
                }
                if (!window.currentFilters.variant) {
                    document.getElementById('variantDropdown').textContent = variantText;
                }
            }
            ...
            const otherRequests = fieldsToUpdate.map(fieldName =>
                ...
                .then(response => response.json())
                .then(data => {
                    updateDropdownOptions(fieldName, data[fieldName === 'pricefrom' || fieldName === 'priceto' ?
                        'price' : (fieldName === 'yearfrom' || fieldName === 'yearto' ? 'year' : fieldName)
                    ]);
                })
            ...
            fetch(`/fetch-models?${params.toString()}`)
                ...
                .then(data => {
                    ...
                    if (currentSelectedModel) {
                        const isStillValid = validModels.some(model => String(model.model) === String(
                ...
                .then(data => {
                    ...
                    if (data.variants && Array.isArray(data.variants)) {
                        ...
                        validVariants.forEach(variant => {
                            const isSelected = String(variant.variant) === String(window.currentFilters
                                .variant);
                    ...
                    if (currentSelectedVariant) {
                        const isStillValid = validVariants.some(variant => String(variant.variant) === String(
